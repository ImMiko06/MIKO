...
# Загрузка фона и его масштабирование
background = pygame.image.load(r"C:\\All Labka\\labs\\lab 8\\racer things\\AnimatedStreet.png")
background = pygame.transform.scale(background, (SCREEN_WIDTH, SCREEN_HEIGHT))  # Масштабируем изображение под размер экрана
